...
SWIFT_CLASS("_TtC10CECManager17ClientInformation")
@interface ClientInformation : UIViewController
@property (nonatomic, strong) CELocationDataController * _Null_unspecified locationController;
